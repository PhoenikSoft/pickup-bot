...
@AllArgsConstructor
@Slf4j
public class GetDateAdviceCommand extends SendMessageListCommand {
    ...
    protected List<SendMessage> getMessages(TelegramCommandInput input) {
        UserQuery query = UserQuery.builder()
                .command(UserCommand.GET_DATE_ADVICE)
                .build();
        ...
        String[][] nextMessageButtons = {{GET_DATE_ADVICE_COMMAND}, {RETURN_TO_MAIN_MENU_COMMAND}};
