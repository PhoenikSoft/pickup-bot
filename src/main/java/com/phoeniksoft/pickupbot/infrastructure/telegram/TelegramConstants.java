...
public interface TelegramConstants {
    ...
    String SEND_YOUR_MESSAGE_MSG = "Впиши свое сообщение ниже и мы рассмотрим его (это анонимно). Возможно оно появится в нашем списке и ты поможешь другим парням. " +
            "На то, чтобы вписать свое сообщение у тебя есть 10 минут. Также существует лимит на количество твоих предложений - 10 сообщений. Можешь вписать его позже, просто отправь свое сообщение боту :)";
    String THANK_YOU_FOR_YOUR_MESSAGE_MSG = "Спасибо за твой вклад!";
    String USER_PROPOSALS_LIMIT_EXCEEDED_MSG = "К сожалению твой лимит на сообщения исчерпан :(";
